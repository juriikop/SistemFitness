...
public class RecognizeVoiceComponent extends BaseComponent {
    ...
    public RecognizeVoiceComponent(IBase iBase, ParamComponent paramMV, MultiComponents multiComponent) {
    ...
    public void initView() {
        ...
        if (view == null) {
            iBase.log("Не найден ClickView в " + paramMV.nameParentComponent);
            return;
        }
        if (textView == null) {
            iBase.log("Не найден TextView для вывода распознаного текста в " + paramMV.nameParentComponent);
            return;
        }
